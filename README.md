...
Visual game engine kernel: event sheets, object layers, condition-action system.

Part of the Counted fleet (sc-gdevelop), stack class `frontend`, generated
from `seeds/seeds.yaml`.

## Architecture (docs/REPO_STANDARD.md)

- `src/lib/modules.ts` — module registry: EventSheets, ObjectLayers, ConditionActions
