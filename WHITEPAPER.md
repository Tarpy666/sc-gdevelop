...
**Fleet designation:** `sc-gdevelop` · Part of the Counted fleet.

## Abstract

Visual game engine kernel: event sheets, object layers, condition-action system. This repository ships a self-contained, deterministic implementation:
